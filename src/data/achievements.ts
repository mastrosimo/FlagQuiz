...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: 'travel-first',
    titleKey: 'achievements.travelFirstTitle',
    descriptionKey: 'achievements.travelFirstDescription',
    icon: '✈️',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 1,
  },
  {
    id: 'travel-5',
    titleKey: 'achievements.travel5Title',
    descriptionKey: 'achievements.travel5Description',
    icon: '🧳',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 5,
  },
  {
    id: 'travel-10',
    titleKey: 'achievements.travel10Title',
    descriptionKey: 'achievements.travel10Description',
    icon: '🧭',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 10,
  },
  {
    id: 'travel-25',
    titleKey: 'achievements.travel25Title',
    descriptionKey: 'achievements.travel25Description',
    icon: '🌍',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 25,
  },
  {
    id: 'travel-50',
    titleKey: 'achievements.travel50Title',
    descriptionKey: 'achievements.travel50Description',
    icon: '🌎',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 50,
  },
  {
    id: 'travel-100',
    titleKey: 'achievements.travel100Title',
    descriptionKey: 'achievements.travel100Description',
    icon: '🌐',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= 100,
  },
  {
    id: 'travel-complete',
    titleKey: 'achievements.travelCompleteTitle',
    descriptionKey: 'achievements.travelCompleteDescription',
    icon: '👑',
    check: ({ visitedCount }: AchievementContext) => visitedCount >= COUNTRIES.length,
  },
];
